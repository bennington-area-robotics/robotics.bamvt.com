...
- **Main layout** (`_layouts/default.html`): Template with all HTML structure and inline CSS. Provides header with navigation, main content area, and footer. Navigation comes from its comma-separated `nav_items` assignment (`Label:/path`).
