...
**DRAFT** — this code of conduct is a working draft, circulating for feedback from senior students, coaches, and families. Nothing on this page is in effect yet.
...
The regular meeting schedule is posted on [our home page](https://robotics.bamvt.com/#meeting-schedule). The season runs in pulses, and during those pulses we meet three or four times a week. This is when attendance matters most:
...
This matters most for attendance and planning. If you can come, say yes. If you can't, say no. If you are unsure, say maybe — an honest maybe beats a soft yes. It is tempting to say yes because yes feels easier in the moment. Then the night before, the yes turns into a no. Do not do this. It is unfair to teammates who planned around you, and it costs the team time and morale. 

When circumstances genuinely change, say so as early as you can. If you simply change your mind about what you'd rather be doing, finish what you committed to and revisit at the next round of work.
...
Ask the slower questions instead: what happened, what conditions made it possible, and what can we change so it doesn't happen again. Sometimes the cause is a person's mistake — and if so, we name it without theatrics, fix it, and move on.
...
- Stepping away to cool off when frustrated, rather than taking it out on tools or teammates.  
- Saying "I don't know," "I forgot," and "I was wrong" directly, when it's true.  
...
- Cleaning your station and putting tools back at the end of the night.  
- Saying yes, no, or an honest maybe — and following through on your yes.  
- Asking "why did this happen?" before asking "whose fault was it?"  
- Treating "my part works" as a hypothesis to test, not a defense.  
...
- Shadow-punching the printer, kicking a robot, slamming tools.  
- Swearing or vulgar jokes in the shop.  
- Carrying grudges from school into the team.  
- Pretending to know something you don't, or getting defensive when corrected.  
- Standing around waiting to be told what to do.  
- Slipping out without telling anyone, or leaving your station a mess.  
- "Maybe" used as a soft no.  
- Reflexive blaming when something breaks.  
- Minimizing or deflecting when you've made a mistake.  
- Shrugging off dropped equipment, or blaming someone else for gear that was in your hands.  
- Pushing an ambitious redesign without a plan to cut scope if time runs short.  
- Conversations at full volume in a shared space when others are trying to work.  
...
- The buddy system applies away from the team's base. You do not leave the hotel, the venue, or the team's location without a partner, and without checking out with a coach.  
- Curfew applies. Lights out is set by the coaches and announced before each trip.  
- In public spaces — hotel halls, restaurants, host venues — act as guests representing the team and FIRST.
...
3. Suspension from a meeting, event, or competition trip.  
